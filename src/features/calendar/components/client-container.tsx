...
export function ClientContainer({ view }: IProps) {
   ...
   return (
      <div className="overflow-hidden rounded-xl border">
         <CalendarHeader events={filteredEvents} view={view} />

         <DndProviderWrapper>
            {view === 'day' && <CalendarDayView multiDayEvents={multiDayEvents} singleDayEvents={singleDayEvents} />}
            {view === 'month' && <CalendarMonthView multiDayEvents={multiDayEvents} singleDayEvents={singleDayEvents} />}
            {view === 'week' && <CalendarWeekView multiDayEvents={multiDayEvents} singleDayEvents={singleDayEvents} />}
            {view === 'year' && <CalendarYearView allEvents={eventStartDates} />}
            {view === 'agenda' && <CalendarAgendaView multiDayEvents={multiDayEvents} singleDayEvents={singleDayEvents} />}
         </DndProviderWrapper>
      </div>
   )
}
