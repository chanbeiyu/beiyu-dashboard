...
import { getCurrentEvents, getEventBlockStyle, getVisibleHours, groupEvents, isWorkingHour } from '../../types/helpers'
   ...
   return (
      <div className="flex">
         <div className="flex flex-1 flex-col">
            <div>
               <DayViewMultiDayEventsRow multiDayEvents={multiDayEvents} selectedDate={selectedDate} />
               ...
               <div className="flex">
                  ...
                  <div className="relative w-18">
                     {hours.map((hour, index) => (
                        <div className="relative" key={hour} style={{ height: '96px' }}>
                  ...
                  <div className="relative flex-1 border-l">
                     <div className="relative">
                        {hours.map((hour, index) => {
                           ...
                           return (
                              <div className={cn('relative', isDisabled && 'bg-calendar-disabled-hour')} key={hour} style={{ height: '96px' }}>
                        ...
                        {groupedEvents.map((group, groupIndex) =>
                           group.map((event) => {
                              ...
                              return (
                                 <div className="absolute p-1" key={event.id} style={style}>
         ...
         <div className="hidden w-64 divide-y border-l md:block">
            <SingleCalendar className="mx-auto w-fit" initialFocus mode="single" onSelect={setSelectedDate} selected={selectedDate} />
                  ...
                  <ScrollArea className="h-[422px] px-4" type="always">
                     <div className="space-y-6 pb-4">
                        {currentEvents.map((event) => {
                           ...
                           return (
                              <div className="space-y-1.5" key={event.id}>
