...
import { getEventBlockStyle, getVisibleHours, groupEvents, isWorkingHour } from '../../types/helpers'
   ...
   return (
      <>
         ...
         <div className="hidden flex-col sm:flex">
            <div>
               <WeekViewMultiDayEventsRow multiDayEvents={multiDayEvents} selectedDate={selectedDate} />
               ...
               <div className="relative z-20 flex border-b">
                  ...
                  <div className="grid flex-1 grid-cols-7 divide-x border-l">
                     {weekDays.map((day, index) => (
                        <span className="py-2 text-center text-xs font-medium text-muted-foreground" key={index}>
                           {format(day, 'EE')}
                           {' '}
