   ...
   return (
      <DraggableEvent event={event}>
         <EventDetailsDialog event={event}>
            <div className={calendarWeekEventCardClasses} onKeyDown={handleKeyDown} role="button" style={{ height: `${heightInPixels}px` }} tabIndex={0}>
               <div className="flex items-center gap-1.5 truncate">
                  {['mixed', 'dot'].includes(badgeVariant) && (
                     <svg className="event-dot shrink-0" height="8" viewBox="0 0 8 8" width="8">
