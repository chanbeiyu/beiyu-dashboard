...
/**
 * Formats a color value to a specific format.
 *
 * @param {string} colorValue - The color value to format.
 * @param {ColorFormat} format - The format to convert the color to.  'hsl' | 'rgb' | 'oklch' | 'hex'
